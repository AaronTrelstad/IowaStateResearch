...
function getAllDataFromTable(tableName) {
    return __awaiter(this, void 0, void 0, function () {
        var params, allData, scanResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (scanResult.LastEvaluatedKey) return [3 /*break*/, 1];
                    _a.label = 4;
...
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                tableName = (_a = event.queryStringParameters) === null || _a === void 0 ? void 0 : _a.tableName;
                if (!tableName) {
                    return [2 /*return*/, {
                            statusCode: 400,
                            headers: {
                ...
                return [4 /*yield*/, getAllDataFromTable(tableName)];
            case 2:
                allData = _b.sent();
                return [2 /*return*/, {
                        statusCode: 200,
